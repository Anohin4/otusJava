...
import ru.otus.exceptions.DoesntHaveRequiredBanknotesException;
import ru.otus.exceptions.DoesntHaveSoMuchMoneyException;
...
public class WithdrawServiceImpl implements WithdrawService {
    ...
    public List<Banknote> withdrawBanknotes(int amount) {
        if(!moneyStorage.hasThatAmountOfMoney(amount)){
